...
function compile_literal(state::DefIdState, nctx::NodeCtx, ::SegmentDef, args::Vector{Any})
...
function compile_skip(state::DefIdState, nctx::NodeCtx, ::SegmentDef, args::Vector{Any})
